...
public class PaymentFailedConsumer : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        try
        {
            ...
            await _channel.QueueDeclareAsync(QueueNames.PaymentFailed,
            ...
            consumer.ReceivedAsync += async (_, ea) =>
            {
                ...
                if (order is not null)
                {
                    ...
                    _logger.LogInformation("Order {OrderId} marked PaymentFailed.", @event.OrderId);
                }

                await _channel.BasicAckAsync(ea.DeliveryTag, false, stoppingToken);
            };

            await _channel.BasicConsumeAsync(QueueNames.PaymentFailed, autoAck: false, consumer: consumer, cancellationToken: stoppingToken);
