...
public class UserRepository : IUserRepository
{
    ...
    public Task<User?> GetByEmailAsync(string e) => _db.Users.AsNoTracking().FirstOrDefaultAsync(u => u.Email == e);
    public Task<User?> GetByRefreshTokenAsync(string refreshToken) => 
        _db.Users.AsNoTracking().FirstOrDefaultAsync(u => u.RefreshToken == refreshToken);
