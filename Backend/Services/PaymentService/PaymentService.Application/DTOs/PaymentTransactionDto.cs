...
/// Order will be created only after payment succeeds.
/// </summary>
public class CreateRazorpayOrderOnlyDto
{
    [Required, Range(1, 9999999)] public decimal Amount { get; set; }
    public string Currency { get; set; } = "INR";
...
/// <summary>
/// Frontend calls this when user cancels/closes Razorpay payment modal.
/// Triggers saga compensation to mark order as PaymentFailed.
/// </summary>
public class CancelPaymentDto
{
    [Required] public Guid OrderId { get; set; }
    public string Reason { get; set; } = "Payment cancelled by user";
}
